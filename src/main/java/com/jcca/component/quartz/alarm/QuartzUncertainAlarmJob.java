    ...
    public void exeJob(){
        ...
        if (Objects.nonNull(level_2) && !level_2.isEmpty()) {
            ...
            for (Map.Entry<String, List<String>> kv : assetAndAlarm.entrySet()) {
                ...
                IEvent event = eventInfoChangeManagerService.creatChangeEvent(asset.getId(), changeInfo, StatusInfoChangeTypeEnum.event_unconfirmed_2.getCode(), eventMapKey, -1,alarmTempReq);
