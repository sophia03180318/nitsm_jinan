...
public class AlarmJobServiceImpl extends ListenerManager implements AlarmJobService {
    ...
    public void pingIpmiPort(Asset asset) {
        ...
        if(!ping){
            ...
            //失败 上失败事件
            IEvent event = eventInfoChangeManagerService.creatChangeEvent(asset.getId(), changeInfo, StatusInfoChangeTypeEnum.event_ipmi_ping.getCode(), eventMapKey, -1,alarmTempReq);
