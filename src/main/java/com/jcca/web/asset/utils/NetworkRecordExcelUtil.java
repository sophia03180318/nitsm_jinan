 ...
 */
@Slf4j
public class NetworkRecordExcelUtil {
    ...
    public static SXSSFWorkbook createExcel(AssetRecordReq req) {
        ...
        CellRangeAddress cellStyle5 = new CellRangeAddress(5, 5, 1, 7);
        CellRangeAddress cellStyle6 = new CellRangeAddress(6, 6, 1, 7);
        CellRangeAddress cellStyle6To7 = new CellRangeAddress(6, 7, 0, 0);
        CellRangeAddress cellStyle7 = new CellRangeAddress(7, 7, 1, 3);
        CellRangeAddress cellStyle7s = new CellRangeAddress(7, 7, 4, 7);
        ...
        sheet.addMergedRegion(cellStyle6To7);
        sheet.addMergedRegion(cellStyle7);
        sheet.addMergedRegion(cellStyle7s);

        SXSSFRow row = sheet.createRow(0);

        SXSSFCell cell = row.createCell(0);

        cell.setCellValue("CTC/TDCS" + req.getPlace().getMsg() + "网络设备履历动态记录表");
        ...
        row5.createCell(0).setCellValue("产品类型：");
        ProductTypeEnum productEnum = ProductTypeEnum.getEnum(req.getAssetMode());
        row5.createCell(1).setCellValue(ProductTypeEnum.changeProduct(productEnum));

        SXSSFRow row6 = sheet.createRow(6);
        row6.createCell(0).setCellValue("硬件配置信息");
        row6.createCell(1).setCellValue("产品型号：" + req.getAssetImage());
        SXSSFRow row7 = sheet.createRow(7);
        row7.createCell(1).setCellValue("电源模块数量：" + req.getPowerTotal());
        row7.createCell(4).setCellValue("电源模块型号：" + req.getPowerModel());

        SXSSFRow row8 = sheet.createRow(8);
        row8.createCell(0).setCellValue("应用软件版本动态");
        row8.createCell(1).setCellValue("名称");
        row8.createCell(2).setCellValue("版本号");
        row8.createCell(3).setCellValue("上道日期");
        row8.createCell(4).setCellValue("下道日期");
        row8.createCell(5).setCellValue("变更原因");
        row8.createCell(6).setCellValue("厂家签名");
        row8.createCell(7).setCellValue("中心签名");
     ...
     * @return
     */
    public static SXSSFCell setCellStyle(SXSSFRow row, int cellNum, CellStyle style, String cellMsg) {
