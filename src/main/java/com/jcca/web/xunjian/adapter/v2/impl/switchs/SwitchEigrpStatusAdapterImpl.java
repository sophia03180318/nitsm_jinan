...
@Service
@Slf4j
public class SwitchEigrpStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "show ip eigrp nei";
    private static final String commandName = "查看EIGRP邻居";
    ...
    public String getCode() {
        return XunjianItemCode.SWITCH_EIGRP;
    }
