...
@Service
@Slf4j
public class OpticalFanStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "fanshow";
    private static final String commandName = "查看交换机风扇状态";
    ...
    public String getCode() {
        return XunjianItemCode.OPTICAL_FAN_STATUS;
    }
    ...
    public XunjianDetailV2 xunJian(Asset asset, String xunjianRecordId,String orgMsg) {
        ...
        try {
            ...
            for (String line : lineArray) {
                ...
                if(!lineLower.toLowerCase().contains("ok")){
                    errorStr.append("【");
