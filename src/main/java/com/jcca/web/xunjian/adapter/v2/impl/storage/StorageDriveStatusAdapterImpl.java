...
@Service
@Slf4j
public class StorageDriveStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "lsenclosureslot";
    private static final String commandName = "查看驱动器插槽状态";
    ...
    public String getCode() {
        return XunjianItemCode.STORAGE_DRIVE_STATUS;
    }
    ...
    public XunjianDetailV2 xunJian(Asset asset, String xunjianRecordId,String orgMsg) {
        ...
        try {
            ...
            for (int i = 1;i<lineArray.length;i++){
                ...
                String port1Status = cellArray[2].toLowerCase();
                String port2Status = cellArray[3].toLowerCase();
                if(!"online".equals(port1Status)||!"online".equals(port2Status)){
