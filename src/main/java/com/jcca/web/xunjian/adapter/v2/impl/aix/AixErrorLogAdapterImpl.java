...
@Slf4j
@Service
public class AixErrorLogAdapterImpl  implements XunjianV2Adapter {

    private static final String command = "errpt";
    private static final String commandName = "Error log 输出";
    ...
    public String getCode() {
        return XunjianItemCode.AIX_ERROR_LOG;
    }
    ...
    public XunjianDetailV2 xunJian(Asset asset, String xunjianRecordId,String orgData) {
        ...
        try {
            ...
            if(StrUtil.isNotEmpty(sshResult)){
