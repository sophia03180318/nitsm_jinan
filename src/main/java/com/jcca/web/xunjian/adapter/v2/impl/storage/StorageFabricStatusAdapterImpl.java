...
@Service
@Slf4j
public class StorageFabricStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "lsfabric";
    private static final String commandName = "查看与主机之间的光纤通道状态";
    ...
    public String getCode() {
        return XunjianItemCode.STORAGE_FABRIC_STATUS;
    }
    ...
    public XunjianDetailV2 xunJian(Asset asset, String xunjianRecordId,String orgMsg) {
        ...
        try {
            ...
            for (int i = 1;i<lineArray.length;i++){
                ...
                String status = cellArray[7].toLowerCase();
