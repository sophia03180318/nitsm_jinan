...
@Service
@Slf4j
public class RoutePcbStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "show plat";
    ...
    public String getCode() {
        return XunjianItemCode.ROUTE_PCB_STATUS;
    }
