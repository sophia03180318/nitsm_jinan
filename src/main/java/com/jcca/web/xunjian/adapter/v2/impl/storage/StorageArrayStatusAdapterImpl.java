...
@Service
@Slf4j
public class StorageArrayStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "lsarray";
    private static final String commandName = "查看阵列状态";
    ...
    public String getCode() {
        return XunjianItemCode.STORAGE_ARRAY_STATUS;
    }
