...
@Service
@Slf4j
public class StorageNodeStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "lsenclosurecanister";
    private static final String commandName = "查看控制器节点状态";
    ...
    public String getCode() {
        return XunjianItemCode.STORAGE_NODE_STATUS;
    }
