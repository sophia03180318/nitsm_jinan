...
@Service
@Slf4j
public class OpticalPCBStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "slotshow";
    private static final String commandName = "查看交换机板卡运行状态";
    ...
    public String getCode() {
        return XunjianItemCode.OPTICAL_PCB_STATUS;
    }
