...
@Service
@Slf4j
public class StoragePowerStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "lsenclosurepsu";
    private static final String commandName = "查看电源状态";
    ...
    public String getCode() {
        return XunjianItemCode.STORAGE_POWER_STATUS;
    }
