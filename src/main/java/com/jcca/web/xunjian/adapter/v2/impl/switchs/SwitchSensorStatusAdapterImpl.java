...
@Service
@Slf4j
public class SwitchSensorStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "show environment";
    private static final String commandName = "温度/电源";
    ...
    public String getCode() {
        return XunjianItemCode.SWITCH_SENSOR_STATUS;
    }
