...
@Service
@Slf4j
public class SwitchInterfacesMsgAdapterImpl implements XunjianV2Adapter {

    private static final String command = "show interface brief";
    private static final String commandName = "接口简要信息";
    ...
    public String getCode() {
        return XunjianItemCode.SWITCH_INTERFACES_MSG;
    }
