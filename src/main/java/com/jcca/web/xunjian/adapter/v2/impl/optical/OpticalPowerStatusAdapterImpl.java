...
@Service
@Slf4j
public class OpticalPowerStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "psshow";
    private static final String commandName = "查看交换机电源状态";
    ...
    public String getCode() {
        return XunjianItemCode.OPTICAL_POWER_STATUS;
    }
