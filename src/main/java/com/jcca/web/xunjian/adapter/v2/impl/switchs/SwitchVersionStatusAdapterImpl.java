...
@Service
@Slf4j
public class SwitchVersionStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "show version";
    private static final String commandName = "版本/运行时长";
    ...
    public String getCode() {
        return XunjianItemCode.SWITCH_VERSION;
    }
