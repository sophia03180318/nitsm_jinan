...
@Service
@Slf4j
public class OpticalErrorsLogsAdapterImpl implements XunjianV2Adapter {

    private static final String command = "errdump -a";
    private static final String commandName = "错误日志";
    ...
    public String getCode() {
        return XunjianItemCode.OPTICAL_ERROR_LOGS;
    }
