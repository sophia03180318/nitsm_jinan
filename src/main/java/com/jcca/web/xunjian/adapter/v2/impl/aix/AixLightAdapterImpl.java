...
@Slf4j
@Service
public class AixLightAdapterImpl  implements XunjianV2Adapter {

    private static final String command = "/usr/lpp/diagnostics/bin/usysfault";
    private static final String commandName = "指示灯状态";
    ...
    public String getCode() {
        return XunjianItemCode.AIX_LIGHT;
    }
    ...
    public XunjianDetailV2 xunJian(Asset asset, String xunjianRecordId,String orgData) {
        ...
        try {
            ...
            String result = sshResult.trim().toLowerCase();
            if("normal".equals(result)){
                ...
                xunjianDetail.setInputErrorStr(result);
            }
