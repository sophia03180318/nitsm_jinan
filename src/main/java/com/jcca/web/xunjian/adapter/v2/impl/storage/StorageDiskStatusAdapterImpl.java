...
@Service
@Slf4j
public class StorageDiskStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "lsdrive";
    private static final String commandName = "查看硬盘状态";
    ...
    public String getCode() {
        return XunjianItemCode.STORAGE_DISK_STATUS;
    }
