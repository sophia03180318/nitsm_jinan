...
@Service
@Slf4j
public class OpticalRunStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "switchstatusshow";
    private static final String commandName = "查看交换机的运行状态";
    ...
    public String getCode() {
        return XunjianItemCode.OPTICAL_RUN_STATUS;
    }
    ...
    public XunjianDetailV2 xunJian(Asset asset, String xunjianRecordId,String orgMsg) {
        ...
        try {
            ...
            for (String line : lineArray) {
                ...
                if(lineLower.toLowerCase().contains("monitor")){
                    if(!lineLower.toUpperCase().contains("HEALTHY")){
                        errorStr.append("【");
