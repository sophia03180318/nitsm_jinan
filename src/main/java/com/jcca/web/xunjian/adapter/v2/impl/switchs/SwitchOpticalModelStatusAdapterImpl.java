...
@Service
@Slf4j
public class SwitchOpticalModelStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "show interface tran detail";
    private static final String commandName = "查看光模块状态";
    ...
    public String getCode() {
        return XunjianItemCode.SWITCH_OPTICAL_MODEL_STATUS;
    }
