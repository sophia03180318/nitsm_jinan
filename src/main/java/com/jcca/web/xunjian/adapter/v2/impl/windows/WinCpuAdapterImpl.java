...
@Slf4j
@Service
public class WinCpuAdapterImpl  implements XunjianV2Adapter {
    ...
    public String getCode() {
        return XunjianItemCode.WIN_CPU;
    }
    ...
    public XunjianDetailV2 xunJian(Asset asset, String xunjianRecordId,String orgMsgStr) {
        ...
        try {
            List<CollectCpu> realTimeData = cpuService.getRealTimeData(asset.getId());
