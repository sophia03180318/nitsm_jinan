...
@Service
@Slf4j
public class SwitchInterfacesIpStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "show ip interface brief";
    private static final String commandName = "接口状态";
    ...
    public String getCode() {
        return XunjianItemCode.SWITCH_INTERFACES_IP_STATUS;
    }
