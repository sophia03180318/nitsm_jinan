...
@Service
@Slf4j
public class SwitchInterfacesStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "show interface status";
    ...
    public String getCode() {
        return XunjianItemCode.SWITCH_INTERFACES_DOWN_STATUS;
    }
