...
@Slf4j
@Service
public class AixAdapterAdapterImpl implements XunjianV2Adapter {

    private static final String command = "lsdev -Cc adapter";
    private static final String commandName = "适配器";
    ...
    public String getCode() {
        return XunjianItemCode.AIX_ADAPTER;
    }
