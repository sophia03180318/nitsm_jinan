...
@Service
@Slf4j
public class SwitchOSPFStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "show ip ospf nei";
    private static final String commandName = "查看OSPF邻居";
    ...
    public String getCode() {
        return XunjianItemCode.SWITCH_OSPF;
    }
