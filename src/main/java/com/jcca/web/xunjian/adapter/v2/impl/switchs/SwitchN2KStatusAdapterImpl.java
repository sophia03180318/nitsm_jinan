...
@Service
@Slf4j
public class SwitchN2KStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "show fex";
    private static final String commandName = "查看N2K状态";
    ...
    public String getCode() {
        return XunjianItemCode.SWITCH_N2K_STATUS;
    }

    @Override
    public String getName(Asset asset) {
        if (!asset.getAssetImage().toUpperCase().contains("7K")) {
            return "";
        }
        return commandName;
    }
