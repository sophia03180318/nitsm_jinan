...
@Service
@Slf4j
public class SwitchPcbStatusAdapterImpl implements XunjianV2Adapter {

    private static final String command = "show mod";
    private static final String commandName = "板卡状态";
    ...
    public String getCode() {
        return XunjianItemCode.SWITCH_PCB_STATUS;
    }
