...
import com.jcca.web.alarm.controller.bean.DisposeAlarmReq;
...
/**
 * @author HanHW
 * @description 批量确认告警 运维日志记录
 * @className DevLogAlarmConfirmBatchImpl
 * @date 2024/4/1 9:46
 * @since 2.1.0.0
 */
@Service
public class DevLogAlarmConfirmBatchImpl implements DevLogService {
    ...
    public String getDevType() {
        return DevLogConstant.ALARM_CONFIRM_BATCH;
    }
    ...
    public void setDevLog(SysActionLog actionLog, Object[] args) {
        Object arg = args[0];
        if (!(arg instanceof DisposeAlarmReq)) {
            return;
        }
        DisposeAlarmReq req = (DisposeAlarmReq) arg;
        ...
        actionLog.setLogName("批量确认" + idList.size() + "条告警");
