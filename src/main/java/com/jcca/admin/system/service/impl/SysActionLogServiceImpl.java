...
public class SysActionLogServiceImpl extends ServiceImpl<SysActionLogMapper, SysActionLog> implements SysActionLogService {
    ...
    public static final String[] tables = {"ALARM_BLACK_LIST", "ALARM_EVENT", "ALARM_EVENT_REL", "ALARM_INFO", "ALARM_RECORD",
            "ALARM_TEMPLATE", "ALARM_WHITE_LIST", "ASSET", "ASSET_ATTACH", "ASSET_HARDWARE_FIX", "ASSET_HID_CONF", "ASSET_IMPORT_RECORD",
            "ASSET_LINK_ASSET", "ASSET_TASK", "BIZ_MANAGE", "BROKEN_RECORD", "BROKEN_RECORD_FILE",
            "BROKEN_RECORD_OPINION", "BROKER_DEVICE_BASE", "BROKER_DEVICE_SYNC_DICT", "BROKER_PROCESS_ALARM", "BROKER_PROCESS_BASE", "BROKER_PROCESS_CONN",
            "BROKER_PROCESS_STATE", "BROKER_REQUEST_LOG", "BROKER_TOPO_BUSINESS", "C_CLUSTER", "CABINET", "CABINET_TASK", "CASCO_ALARM_LINE",
            "CASCO_CAPACITY_ATTR_STATUS", "CASCO_CONN_ATTR_STATUS", "CASCO_DEVICE_SYNC", "CASCO_DEVICE_SYNC_BCF_CONFIG", "CASCO_DEVICE_SYNC_LOG",
            "CASCO_DEVICE_SYNC_ORG_CONFIG", "CASCO_DEVICES", "CASCO_DEVICES_RUN_STATUS", "CASCO_EVENT_ATTR_STATUS", "CASCO_MSG_LOG", "CASCO_TOPO_APP_SERVER",
            "CASCO_TOPO_BASE", "CASCO_TOPO_DISPATCH", "CASCO_TOPO_DIVIDING_SERVER", "CASCO_TOPO_GSMR", "CASCO_TOPO_MESSAGE_SERVER", "CASCO_TOPO_OPERATION",
            "CASCO_TOPO_RAILWAY_SERVER", "CASCO_TOPO_RBC_SERVER", "CASCO_TOPO_STATION", "CASCO_TOPO_STATION_YARD", "CASCO_TOPO_TDMS_SERVER",
            "CASCO_TOPO_TSRS_SERVER", "CASCO_USER_DEF_ATTR_STATUS", "CENTER_NODES", "COLLECT_AIX_ADAPTER", "COLLECT_CLUSTER", "COLLECT_CONNECT",
            "COLLECT_CPU", "COLLECT_DB", "COLLECT_DB_FILE", "COLLECT_DISK", "COLLECT_DS", "COLLECT_INTERFACES", "COLLECT_MEMORY", "COLLECT_NETWORK_CARD",
            "COLLECT_NODE_MONITOR", "COLLECT_NODE_ROUTE", "COLLECT_PCB", "COLLECT_PORT", "COLLECT_PROCESS", "COLLECT_RAID", "COLLECT_ROUTE", "COLLECT_SENSOR",
            "COLLECT_SYSTEM_TIME", "COLLECT_TABLESPACE", "COLLECT_VLAN", "CONSTRUCTION_RECORD", "CYCLES_INFO", "CYCLES_ORG", "CYCLES_TIMES", "DH_ALARM",
            "DH_DEVICE", "DH_NODE", "DH_PROPERTY", "DH_STATION", "HOUR_CPU", "HOUR_INTERFACES", "HOUR_INTERFACES_ITEM", "HOUR_MEMORY", "HOUR_TEMP",
            "IBMMQ_CHANNEL_DATA", "IBMMQ_GROUP", "IBMMQ_HEALTH_MESSAGE", "IBMMQ_LISTENER_DATA", "IBMMQ_MONITOR", "IBMMQ_MONITOR_MEASUREMENTS",
            "IBMMQ_QMGR_CONNECTION", "IBMMQ_QMGR_DATA", "IBMMQ_QUEUE_DATA", "IBMMQ_STATISTICS_DATA", "IBMMQ_TOPIC_DATA", "IMPORT_CABINET", "IMPORT_TEMPLATE",
            "INSPECT_DETAIL", "INSPECT_RECORD", "ITSM_LANGUAGE", "M_DB", "M_IP_INFO", "M_NET_WORK_ADDRESS", "M_NETWORK_ASSET_MAP", "M_STATION_VERSION_LOG",
            "M_VERSION_MSG", "MAINTAIN_BOOK", "MAINTENANCE_PLAN", "MD_REGEX_CATALOG_MVIEW", "MD_REGEX_MVIEW", "MD_REGEX_SCHEMA_MVIEW",
            "MIGR_DATATYPE_TRANSFORM_MAP", "MIGR_DATATYPE_TRANSFORM_RULE", "MIGR_GENERATION_ORDER", "MIGRATION_RESERVED_WORDS", "MIGRLOG", "NIGHT_BOARD",
            "NIGHT_BOARD_PAYLOAD", "NODES_LOG", "NODES_MSG", "PERFORMANCE_TARGET", "PORT_TEMPLATE", "PROMPT_INFO",
            "ROOM", "SERIAL", "SERIAL_ALARM_TYPE", "SERIAL_LOG", "STATION", "SYS_ACTION_LOG",
            "SYS_ACTION_LOG_DETAIL", "SYS_FUNCTION_LOG", "SYS_LOGIN_CONF", "SYS_ORG", "SYS_ROLE", "SYS_ROLE_MENU", "SYS_ROLE_ORG", "SYS_USER_ROLE", "THRESHOLD_ASSET",
            "THRESHOLD_MANAGE", "THRESHOLD_PROCESS", "THRESHOLD_SECTION", "TOPO_ASSET_GROUP", "TOPO_ASSET_MARK", "TOPO_ASSET_PORT",
            "TOPO_ASSET_PORT_VLAN", "TOPO_EDGE", "TOPO_PCB", "TOPO_POINTS", "TOPO_VERTEX", "XUNJIAN_ALARM_MSG", "XUNJIAN_ASSET", "XUNJIAN_DETAIL",
            "XUNJIAN_DETAIL_LOG", "XUNJIAN_DETAIL_V2", "XUNJIAN_RECORD", "XUNJIAN_RECORD_V2"};

    @Override
    public void resetdb() {
        for (String table : tables) {
            actionLogMapper.removeData(table);
        }
    }
}
