 ...
 * @since 2.1.0.0
 */
@Component("beiyangVersionAdapter")
public class BeiyangVersionAdapter extends AssetIpAdd implements IAdapter<ItsmQueueEntity> {
    ...
    public void dispose(ItsmQueueEntity data) {
        ...
        excutorService.submit(new Runnable() {
            ...
            public void run() {
                setAssetIp(data);
                try {
                    dataProcessManager.beiYangVersionHandlerRequest(data);
                } catch (Exception e) {
                    AppLogUtils.buildLogError(LogFunctionEnum.DATA_PROCESS, "设备" + data.getAssetIp() + "beiYangVersionHandlerRequest 抛出异常", e);
                }
            }
        });
    ...
    public String getCode() {
        return CollectConst.BEIYANG_VERSION;
    }
