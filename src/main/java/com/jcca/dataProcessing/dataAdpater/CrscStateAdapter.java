...
/**
 * @author Zhaozheng
 * @description TODO 通号状态信息适配器
 * @className CrscStateAdapter
 * @date 2023/10/20 16:25
 * @since 2.1.0.0
 */
@Component("crscStateAdapter")
public class CrscStateAdapter extends AssetIpAdd implements IAdapter<String> {
    ...
    public void dispose(String data) {
        ...
        Future<Integer> future=excutorService.submit(new Callable<Integer>() {
            ...
            public Integer call() throws Exception {
                ...
                dataProcessManager.crscStateHandlerRequest(itsmQueueReq);
                return 1;
            }
        });
    ...
    public String getCode() {
        return CollectConst.CRSC_STATE;
    }
