...
@Slf4j
@Component("bhmMemoryAdapter")
public class BhmMemoryAdapter extends AssetIpAdd implements IAdapter<JSONArray> {
    ...
    public void dispose(JSONArray data) {
        List<CollectBhmMemoryEntity> queueList = JSONUtil.toList(data, CollectBhmMemoryEntity.class);
        ...
        Future<Integer> future=excutorService.submit(new Callable<Integer>() {
            ...
            public Integer call() throws Exception {
                ...
                for (CollectBhmMemoryEntity item : queueList) {
    ...
    public String getCode() {
        return CollectConst.BHM_MEMORY_MSG;
    }
