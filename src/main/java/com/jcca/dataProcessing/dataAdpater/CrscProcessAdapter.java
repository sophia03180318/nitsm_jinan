...
/**
 * @author Zhaozheng
 * @description TODO 通号进程信息适配器
 * @className CrscProcessAdapter
 * @date 2023/10/20 16:24
 * @since 2.1.0.0
 */
@Component("crscProcessAdapter")
public class CrscProcessAdapter extends AssetIpAdd implements IAdapter<String> {
    ...
    public String getCode() {
        return CollectConst.CRSC_PROCESS;
    }
