...
/**
 * @author Zhaozheng
 * @description TODO 通号连接数据适配器
 * @className CrscLinkAdapter
 * @date 2023/10/20 16:24
 * @since 2.1.0.0
 */
@Component("crscLinkAdapter")
public class CrscLinkAdapter extends AssetIpAdd implements IAdapter<String> {
    ...
    public void dispose(String data) {
        ...
        Future<Integer> future=excutorService.submit(new Callable<Integer>() {
            ...
            public Integer call() throws Exception {
                ...
                dataProcessManager.crscLinkHandlerRequest(itsmQueueReq);
                return 1;
            }
        });
