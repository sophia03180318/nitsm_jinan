...
/**
 * @author Zhaozheng
 * @description TODO casco主备信息适配器
 * @className DisposeCascoMasterAdapter
 * @date 2023/10/20 16:15
 * @since 2.1.0.0
 */
@Component("cascoMasterAdapter")
public class CascoMasterAdapter extends AssetIpAdd implements IAdapter<ItsmQueueEntity> {
    ...
    public String getCode() {
        return CollectConst.CASCO_MASTER;
    }
