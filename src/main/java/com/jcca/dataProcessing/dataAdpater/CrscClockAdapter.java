...
/**
 * @author Zhaozheng
 * @description TODO 通号时间同步数据适配器
 * @className CrscClockAdapter
 * @date 2023/10/20 16:23
 * @since 2.1.0.0
 */
@Component("crscClockAdapter")
public class CrscClockAdapter extends AssetIpAdd implements IAdapter<String> {
    ...
    public void dispose(String data) {
        ...
        excutorService.submit(new Runnable() {
            ...
            public void run() {
                ...
                dataProcessManager.crscClockHandlerRequest(itsmQueueReq);
            }
        });
    ...
    public String getCode() {
        return CollectConst.CRSC_CLOCK;
    }
