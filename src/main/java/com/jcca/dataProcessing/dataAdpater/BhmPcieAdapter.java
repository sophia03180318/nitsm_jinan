...
@Slf4j
@Component("bhmPcieAdapter")
public class BhmPcieAdapter  extends AssetIpAdd implements IAdapter<JSONArray> {
    ...
    public void dispose(JSONArray data) {
        List<CollectBhmPcieEntity> queueList = JSONUtil.toList(data, CollectBhmPcieEntity.class);
        ...
        Future<Integer> future=excutorService.submit(new Callable<Integer>() {
            ...
            public Integer call() throws Exception {
                ...
                for (CollectBhmPcieEntity item : queueList) {
