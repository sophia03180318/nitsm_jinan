...
/**
 * @author Zhaozheng
 * @description TODO casco版本信息适配器
 * @className DisposeCascoVersionAdapter
 * @date 2023/10/20 16:16
 * @since 2.1.0.0
 */
@Component("cascoVersionAdapter")
public class CascoVersionAdapter extends AssetIpAdd implements IAdapter<ItsmQueueEntity> {
    ...
    public void dispose(ItsmQueueEntity data) {
        ...
        excutorService.submit(new Runnable() {
            ...
            public void run() {
                setAssetIp(data);
                try {
                    dataProcessManager.cascoVersionHandlerRequest(data);
                } catch (Exception e) {
                    AppLogUtils.buildLogError(LogFunctionEnum.DATA_PROCESS, "设备" + data.getAssetIp() + "cascoVersionHandlerRequest 抛出异常", e);
                }
            }
        });
    ...
    public String getCode() {
        return CollectConst.CASCO_VERSION;
    }
