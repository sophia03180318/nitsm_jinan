...
/**
 * @author Zhaozheng
 * @description TODO casco容量信息适配器
 * @className DisposeCascoThresholdAdapter
 * @date 2023/10/20 16:15
 * @since 2.1.0.0
 */
@Component("cascoThresholdAdapter")
public class CascoThresholdAdapter extends AssetIpAdd implements IAdapter<ItsmQueueEntity> {
    ...
    public void dispose(ItsmQueueEntity data) {
        ...
        excutorService.submit(new Runnable() {
            ...
            public void run() {
                setAssetIp(data);
                try {
                    dataProcessManager.cascoThreshOldHandlerRequest(data);
                } catch (Exception e) {
                    AppLogUtils.buildLogError(LogFunctionEnum.DATA_PROCESS, "设备" + data.getAssetIp() + "cascoThreshOldHandlerRequest 抛出异常", e);
                }
            }
        });
    ...
    public String getCode() {
        return CollectConst.CASCO_THRESHOLD;
    }
