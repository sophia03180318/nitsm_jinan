...
/**
 * @author Zhaozheng
 * @description TODO casco连接信息适配器
 * @className DisposeCascoLinkAdapter
 * @date 2023/10/20 16:14
 * @since 2.1.0.0
 */
@Component("cascoLinkAdapter")
public class CascoLinkAdapter extends AssetIpAdd implements IAdapter<ItsmQueueEntity> {
    ...
    public String getCode() {
        return CollectConst.CASCO_LINK;
    }
