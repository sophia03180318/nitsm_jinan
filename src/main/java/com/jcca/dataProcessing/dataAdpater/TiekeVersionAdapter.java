...
/**
 * @author Zhaozheng
 * @description TODO 铁科版本信息适配器
 * @className TiekeVersionAdapter
 * @date 2023/10/20 16:26
 * @since 2.1.0.0
 */
@Component("tiekeVersionAdapter")
public class TiekeVersionAdapter extends AssetIpAdd implements IAdapter<ItsmQueueEntity> {
    ...
    public String getCode() {
        return CollectConst.TIEKE_VERSION;
    }
