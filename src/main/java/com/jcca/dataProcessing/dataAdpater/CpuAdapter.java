 ...
 */
@Slf4j
@Component("cpuAdapter")
public class CpuAdapter extends AssetIpAdd implements IAdapter<JSONArray> {
    ...
    public void dispose(JSONArray data) {
        List<CollectCpuEntity> cpus = JSONUtil.toList(data, CollectCpuEntity.class);
