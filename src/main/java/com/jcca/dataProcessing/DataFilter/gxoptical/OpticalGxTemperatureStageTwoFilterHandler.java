 ...
 */
@Component("opticalGxTemperatureStageTwoFilterHandler")
public class OpticalGxTemperatureStageTwoFilterHandler extends IFilterHandler<OpticalSwitchV2Bean> {
    ...
    public boolean handler(OpticalSwitchV2Bean info) {
        ...
        for (TSensor key : temperatureMap) {
            ...
            String serialNumberName = key.getSerialNumberName();
            String mapKey = "temperature" + serialNumberName;

            ChangeInfo changeInfo = info.getMaps().get(mapKey);
            if (null == changeInfo || changeInfo.getIsEvent() != null && changeInfo.getIsEvent() == true) {
                continue;
            }
            ...
            String thresholdMapKey = thresholdManager.getThresholdMapKey(StatusInfoChangeTypeEnum.event_temp_state_sectionTwo.getCode(), StatusInfoChangeTypeEnum.SECTION_TWO.getCode(), "temperature" + key);
            ...
            if (changeInfo.getIsChange() || thresholdFlag) {
                ...
                alarmTempReq.setOrgMsg(String.format(StatusInfoChangeTypeEnum.event_temp_state_sectionThree.getDescr(), mapKey, changeInfo.getValue(), keyWord, threshold.getTwoLevelValue()));
                ...
                if (event != null) {
                    ...
                    event.setDescStr(String.format(StatusInfoChangeTypeEnum.event_temp_state_sectionTwo.getDescr(), mapKey, changeInfo.getValue(), keyWord, threshold.getTwoLevelValue()));
                    this.dispatureEvent(event);
                }
            }
