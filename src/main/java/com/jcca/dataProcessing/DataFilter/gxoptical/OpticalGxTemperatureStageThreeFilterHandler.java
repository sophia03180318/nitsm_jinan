 ...
 * 阶段阈值处理类  中间级别
 */
@Component("opticalGxTemperatureStageThreeFilterHandler")
public class OpticalGxTemperatureStageThreeFilterHandler extends IFilterHandler<OpticalSwitchV2Bean> {
    ...
    public boolean handler(OpticalSwitchV2Bean info) {
        ...
        for (TSensor key : temperatureMap) {
            ...
            if (null == changeInfo || changeInfo.getIsEvent() != null && changeInfo.getIsEvent()) {
                continue;
            }
