...
public class BhmMemoryStatusFilterHandler extends IFilterHandler<CollectBhmMemoryEntity> {

    @Resource
    private IEventInfoManagerService eventInfoChangeManagerService;

    @Override
    public boolean handler(CollectBhmMemoryEntity memory) throws ResultException, Exception {
