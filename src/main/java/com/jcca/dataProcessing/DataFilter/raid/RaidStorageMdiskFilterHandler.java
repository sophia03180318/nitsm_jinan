...
/**
 * @author Zhaozheng
 * @description TODO Raid存储 Mdisk过滤处理类
 * @className StorageMdiskFilterHandler
 * @date 2023/10/27 9:34
 * @since 2.1.0.0
 */
@Component("raidStorageMdiskFilterHandler")
public class RaidStorageMdiskFilterHandler extends IFilterHandler<DiskEntity> {
