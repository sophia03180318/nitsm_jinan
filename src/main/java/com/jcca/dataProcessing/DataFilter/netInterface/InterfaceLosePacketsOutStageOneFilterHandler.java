 ...
 */
@Component("interfaceLosePacketsOutStageOneFilterHandler")
public class InterfaceLosePacketsOutStageOneFilterHandler extends IFilterHandler<CollectInterfaceEntity> {
    ...
    public boolean handler(CollectInterfaceEntity info) {
        ...
        String eventRedisKey = StatusInfoChangeTypeEnum.event_port_outLose_sectionOne.getCode();
        ...
        String thresholdMapKey = thresholdManager.getThresholdMapKey(StatusInfoChangeTypeEnum.event_port_outLose_sectionOne.getCode(),StatusInfoChangeTypeEnum.SECTION_ONE.getCode(),info.getPortName());
        ...
        if (changeInfo.getIsChange() || thresholdFlag) {
            ...
            String descStr = String.format(StatusInfoChangeTypeEnum.event_port_outLose_sectionOne.getDescr(), info.getPortName(), changeInfo.getValue(), keyWord, threshold.getOneLevelValue());
            ...
            this.addEventStatus(StatusInfoChangeTypeEnum.event_port_outLose_sectionOne.getCode(),StatusInfoChangeTypeEnum.SECTION_ONE_VAL.getCode(),info.getPortName(), status, info, changeInfo);
