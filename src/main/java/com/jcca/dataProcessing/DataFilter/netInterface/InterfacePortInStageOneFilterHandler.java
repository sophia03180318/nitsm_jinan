 ...
 */
@Component("interfacePortInStageOneFilterHandler")
public class InterfacePortInStageOneFilterHandler extends IFilterHandler<CollectInterfaceEntity> {
    ...
    public boolean handler(CollectInterfaceEntity info) {
        ...
        String eventRedisKey = StatusInfoChangeTypeEnum.event_port_in_sectionOne.getCode();
        ...
        String thresholdMapKey = thresholdManager.getThresholdMapKey(StatusInfoChangeTypeEnum.event_port_in_sectionOne.getCode(),StatusInfoChangeTypeEnum.SECTION_ONE.getCode(),info.getPortName());
        ...
        if (changeInfo.getIsChange() || thresholdFlag) {
            ...
            this.addEventStatus(StatusInfoChangeTypeEnum.event_port_in_sectionOne.getCode(),StatusInfoChangeTypeEnum.SECTION_ONE_VAL.getCode(),info.getPortName(), status, info, changeInfo);
            String keyWord = status.equals(EventLevelEnum.NORMAL.getCode()) ? "" : "超过";
            String descStr = String.format(StatusInfoChangeTypeEnum.event_port_in_sectionOne.getDescr(), info.getPortName(), changeInfo.getValue(), keyWord, threshold.getOneLevelValue());
