 ...
 */
@Component("interfaceTxPowerTwoFilterHandler")
public class InterfaceTxPowerTwoFilterHandler extends IFilterHandler<CollectInterfaceEntity> {
    ...
    public boolean handler(CollectInterfaceEntity info) {
        ...
        String eventRedisKey = StatusInfoChangeTypeEnum.event_port_optical_out_sectionTwo.getCode();
        ...
        String thresholdMapKey = thresholdManager.getThresholdMapKey(StatusInfoChangeTypeEnum.event_port_optical_out_sectionTwo.getCode(), StatusInfoChangeTypeEnum.SECTION_TWO.getCode(), info.getPortName());
        ...
        if (changeInfo.getIsChange() || thresholdFlag) {
            ...
            String descStr = String.format(StatusInfoChangeTypeEnum.event_port_optical_out_sectionTwo.getDescr(), info.getPortName(), changeInfo.getValue(), keyWord, threshold.getTwoLevelValue());
            ...
            this.addEventStatus(StatusInfoChangeTypeEnum.event_port_optical_out_sectionTwo.getCode(), StatusInfoChangeTypeEnum.SECTION_TWO_VAL.getCode(), info.getPortName(), status, info, changeInfo);
