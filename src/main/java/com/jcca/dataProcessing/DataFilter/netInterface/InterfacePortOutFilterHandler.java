 ...
 * @since 2.1.0.0
 */
@Component("interfacePortOutFilterHandler")
public class InterfacePortOutFilterHandler extends IFilterHandler<CollectInterfaceEntity> {
    ...
    public boolean handler(CollectInterfaceEntity info) {
        ...
        String eventRedisKey = StatusInfoChangeTypeEnum.event_port_out_normal.getCode();
        ...
        String thresholdMapKey = thresholdManager.getThresholdMapKey(StatusInfoChangeTypeEnum.event_port_out_normal.getCode(),StatusInfoChangeTypeEnum.NORMAL.getCode(),info.getPortName());
        ...
        if (changeInfo.getIsChange() || thresholdFlag) {
            ...
            String descStr = String.format(StatusInfoChangeTypeEnum.event_port_out_normal.getDescr(), info.getPortName(), changeInfo.getValue(), keyWord, threshold.getBaseValue());
            ...
            this.addEventStatus(StatusInfoChangeTypeEnum.event_port_out_normal.getCode(),StatusInfoChangeTypeEnum.NORMAL_VAL.getCode(),info.getPortName(), status, info, changeInfo);
