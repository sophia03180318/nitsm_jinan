 ...
 */
@Component("interfaceErrorCodeOutSectionFilterHandler")
public class InterfaceErrorCodeOutSectionFilterHandler extends IFilterHandler<CollectInterfaceEntity> {
    ...
    public boolean handler(CollectInterfaceEntity info) {
        ...
        String eventRedisKey = StatusInfoChangeTypeEnum.event_port_outError_section.getCode();
        ...
        String thresholdMapKey = thresholdManager.getThresholdMapKey(StatusInfoChangeTypeEnum.event_port_outError_section.getCode(),StatusInfoChangeTypeEnum.SECTION.getCode(),info.getPortName());

        ThresholdBaseEntity threshold = thresholdManager.getThresholdValue(StatusInfoChangeTypeEnum.event_port_outError_normal.getCode(), info.getAssetId(), info.getPortName());
        ...
        if (changeInfo.getIsChange() || thresholdFlag) {
            ...
            String descStr = String.format(StatusInfoChangeTypeEnum.event_port_outError_section.getDescr(), info.getPortName(), changeInfo.getValue(), keyWord, threshold.getMinValue(), threshold.getMaxValue());
            ...
            this.addEventStatus(StatusInfoChangeTypeEnum.event_port_outError_section.getCode(),StatusInfoChangeTypeEnum.SECTION_VAL.getCode(),info.getPortName(), status, info, changeInfo);
