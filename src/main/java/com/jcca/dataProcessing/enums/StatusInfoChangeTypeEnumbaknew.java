 ...
 */
@Getter
public enum StatusInfoChangeTypeEnumbaknew {
    /**
     * 设备基础状态信息
     */
    status("status", "设备状态", ""),
    ...
    //进程事件对应的状态数据
    status_process_cpu("status:process_cpu", "进程CPU阈值状态", ""),
    status_process_mem("status:process_mem", "进程内存阈值状态", ""),
    status_process_status("status:process_status", "进程状态", ""),


    //存储状态事件
    event_storage("event:event_storage", "存储状态", ""),
    event_storage_controller("event:event_storage:controller", "存储控制器事件", "存储控制器%s发生故障。"),
    event_storage_capacity("event:event_storage:capacity", "存储容量事件", "存储容量超过设定值。"),
    event_storage_group("event:event_storage:group", "存储group事件", "存储组%s发生故障。"),
    event_storage_Mdisk("event:event_storage:Mdisk", "存储Mdisk事件", "存储磁盘%s发生故障。"),
    event_storage_driver("event:event_storage:driver", "存储driver事件", "存储driver:%s 发生故障。"),
    event_storage_Vdisk("event:event_storage:Vdisk", "存储Vdisk事件", "存储Vdisk:%s 发生故障。"),
    event_storage_link("event:event_storage:link", "存储连接事件", "存储连击发生故障。"),
    //存储事件对应的状态信息
    ...
    StatusInfoChangeTypeEnumbaknew(String code, String name, String descr) {
        this.code = code;
        this.name = name;
        this.descr = descr;
    }
    ...
    public static String getName(String code) {
        StatusInfoChangeTypeEnumbaknew[] values = StatusInfoChangeTypeEnumbaknew.values();
        for (StatusInfoChangeTypeEnumbaknew value : values) {
