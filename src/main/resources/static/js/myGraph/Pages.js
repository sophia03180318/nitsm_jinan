...
SelectPage.prototype.execute = function()
{
	...
	if (this.page != null && prevIndex >= 0)
	{
		...
		graph.model.prefix = myGraphEditor.guid() + '-';
 ...
 */
myGraphEditorUI.prototype.tabContainerHeight = 38;

/**
 * Returns the index of the selected page.
 */
myGraphEditorUI.prototype.getSelectedPageIndex = function()
{
	console.log('选中的页面索引' + this.getPageIndex(this.currentPage))
 ...
 */
myGraphEditorUI.prototype.getPageIndex = function(page)
 {
	 var result = null;
 ...
 */
myGraphEditorUI.prototype.getPageById = function(id)
{
	if (this.pages != null)
	{
		for (var i = 0; i < this.pages.length; i++)
 ...
 */
myGraphEditorUI.prototype.createImageForPageLink = function(src, sourcePage, sourceGraph)
{
 ...
 * Returns true if the given string contains an mxfile.
 */
myGraphEditorUI.prototype.getImageForPage = function(page, sourcePage, sourceGraph)
{
 ...
 * Returns true if the given string contains an mxfile.
 */
myGraphEditorUI.prototype.initPages = function()
{
	if (!this.editor.graph.standalone)
	{
		...
		var updateTabs = mxUtils.bind(this, function()
		{
			...
			else if (typeof(myGraphEditor.MathJaxClear) !== 'undefined' && (this.editor == null || !this.editor.graph.mathEnabled))
			{
				// Clears our own queue for async loading
				myGraphEditor.MathJaxClear();
			}
		});
 ...
 */
myGraphEditorUI.prototype.restoreViewState = function(page, viewState, selection)
{
 ...
 * Executes selection of a new page.
 */
myGraphEditorUI.prototype.updatePageRoot = function(page, checked)
{
	if (page.root == null)
	{
		var node = this.editor.extractGraphModel(page.node, null, checked);
		var cause = myGraphEditor.extractParserError(node);
 ...
 * Returns true if the given string contains an mxfile.
 */
myGraphEditorUI.prototype.selectPage = function(page, quiet, viewState,pageName)
{
 ...
 * 
 */
myGraphEditorUI.prototype.selectNextPage = function(forward)
{
 ...
 * Returns true if the given string contains an mxfile.
 */
myGraphEditorUI.prototype.insertPage = function(page, index,pageName,assetId)
{
	if (this.editor.graph.isEnabled())
	{
		...
		page = (page != null) ? page : this.createPage(pageName,assetId==null?this.createPageId():assetId);
 ...
 */
myGraphEditorUI.prototype.createPageId = function()
{
	var id = null;
	
	do
	{
		id = myGraphEditor.guid();
 ...
 */
myGraphEditorUI.prototype.createPage = function(name, id)
{
 ...
 * Returns a page name.
 */
myGraphEditorUI.prototype.createPageName = function()
{
 ...
 */
myGraphEditorUI.prototype.removePage = function(page)
{
	try
	{
		var graph = this.editor.graph;
 ...
 */
myGraphEditorUI.prototype.duplicatePage = function(page, name)
{
	var newPage = null;
...
myGraphEditorUI.prototype.renamePage = function(page)
{
	var graph = this.editor.graph;
 ...
 * Returns true if the given string contains an mxfile.
 */
myGraphEditorUI.prototype.movePage = function(oldIndex, newIndex)
{
 ...
 * Returns true if the given string contains an mxfile.
 */
myGraphEditorUI.prototype.createTabContainer = function()
{
 ...
 * Returns true if the given string contains an mxfile.
 */
myGraphEditorUI.prototype.updateTabContainer = function(flag,assetId)
{
	if (this.tabContainer != null && this.pages != null)
	{
		...
		var startIndex = null;
		if(flag){ //点击节点添加一个page
			this.insertPage(null,null,flag,assetId);
		}
		//}));
		for (var i = 0; i < this.pages.length; i++)
		{
 ...
 * Returns true if the given string contains an mxfile.
 */
myGraphEditorUI.prototype.isPageInsertTabVisible = function()
{
	return true;
};
 ...
 * Returns true if the given string contains an mxfile.
 */
myGraphEditorUI.prototype.createTab = function(hoverEnabled)
{
 ...
 * Returns true if the given string contains an mxfile.
 */
myGraphEditorUI.prototype.createControlTab = function(paddingTop, html, hoverEnabled)
{
 ...
 * Returns true if the given string contains an mxfile.
 */
myGraphEditorUI.prototype.createPageMenuTab = function(hoverEnabled)
{
		...
		var menu = new mxPopupMenu(mxUtils.bind(this, function(menu, parent)
		{
			for (var i = 0; i < this.pages.length; i++)
			{
				(mxUtils.bind(this, function(index)
				{
					...
					if (this.pages[index] == this.currentPage)
					{
						menu.addCheckmark(item, myGraphEditor.checkmarkImage);
					}
				}))(i);
			}
			...
			if (page != null)
			{
				...
				if(page.node.id != '0')
				menu.addItem("remove "+pageName, null, mxUtils.bind(this, function()
				{
 ...
 * Returns true if the given string contains an mxfile.
 */
/*myGraphEditorUI.prototype.createPageInsertTab = function()
{
	var tab = this.createControlTab(4, '<div class="geSprite geSprite-plus"></div>');
	tab.setAttribute('title', 'plus');
	var graph = this.editor.graph;
 ...
 * Returns true if the given string contains an mxfile.
 */
myGraphEditorUI.prototype.createTabForPage = function(page, tabWidth, hoverEnabled, pageNumber)
{
 ...
 */
myGraphEditorUI.prototype.addTabListeners = function(page, tab)
{
 ...
 * Returns true if the given string contains an mxfile.
 */
myGraphEditorUI.prototype.createPageMenu = function(page, label)
{
	return mxUtils.bind(this, function(menu, parent)
	{
		...
		var model = graph.model;
		if(page.node.id != '0'){
			menu.addItem("删除", null, mxUtils.bind(this, function()
			{
				this.removePage(page);
			}), parent);
		}
...
(function()
{
	var editorUiRefresh = myGraphEditorUI.prototype.refresh;
