 ...
 */
function mxCell(value, geometry, style, assetId, assetType, isPort) {
    this.value = value;
...
// 连线初始化位置
mxCell.prototype.position = null;
...
mxCell.prototype.getPortIndex = function () {
 ...
 * 获取AssetID
 */
mxCell.prototype.getAssetId = function () {
    return this.assetId;
};
 ...
 * 设置AssetType
 */
mxCell.prototype.setAssetId = function (assetId) {
    this.assetId = assetId;
};
/**
 * 设置是否为端口
 */
mxCell.prototype.setIsPort = function (isPort) {
    this.isPort = isPort;
};

mxCell.prototype.getIsPort = function () {
    return this.isPort;
};
/**
 * 获取AssetType
 */
mxCell.prototype.getAssetType = function () {
 ...
 * 设置AssetId
 */
mxCell.prototype.setAssetType = function (assetType) {
    this.assetType = assetType;
};

mxCell.prototype.setPortMode = function (portMode) {
